    ...
    <header className="border-b border-border/60 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-40">
      <div className="container-prose flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to="/auth"><Button size="sm">Solicitar acesso</Button></Link>
        </div>
      </div>
    </header>
  );
      ...
      <div className="container-prose py-24 md:py-32 grid gap-12 md:grid-cols-[1.2fr_1fr] items-center">
        <div>
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            <Link to="/auth"><Button size="lg">Começar avaliação</Button></Link>
        ...
        <aside className="relative">
          <div className="rounded-2xl border border-border bg-card p-6 shadow-[var(--shadow-card)]">
            ...
            <h3 className="mt-2 font-serif text-xl">Operação policial em Venda Nova mobiliza moradores</h3>
            <p className="mt-2 text-sm text-muted-foreground line-clamp-3">
              Reportagem do Estado de Minas aponta apreensão de armas e dois feridos. Repercussão alta nas
              redes regionais. Recomenda-se posicionamento ainda hoje.
            </p>
            <div className="mt-4 flex items-center justify-between">
              <span className="text-xs uppercase tracking-wider text-muted-foreground">Segurança Pública</span>
    ...
    <section id="como-funciona" className="border-b border-border/60">
      <div className="container-prose py-24">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-serif text-3xl md:text-4xl">Três passos entre a notícia e o post.</h2>
        </div>
...
const PLANS = [
  {
    ...
    role: "Assessor",
    price: "R$ 597",
    desc: "Curadoria de conteúdo essencial para um mandato individual.",
    features: ["Radar de notícias a cada 3h", "Até 5 posts gerados / mês", "1 usuário", "Suporte por e-mail"],
  },
  {
    name: "Avançado",
    role: "Estrategista",
    price: "R$ 1.497",
    desc: "Curadoria + sentimento. O painel completo para quem disputa narrativa.",
    features: ["Tudo do Básico", "Posts ilimitados", "Termômetro social do Instagram", "Análise de sentimento de comentários"],
    featured: true,
  },
  {
    name: "Enterprise",
    role: "Gabinete",
    price: "R$ 2.497",
    desc: "Inteligência total para equipes que comandam pauta política.",
    features: ["Tudo do Avançado", "Scraping de menções externas", "Multi-usuários para a equipe", "Onboarding dedicado"],
  },
];
    ...
    <section id="planos" className="border-b border-border/60 bg-secondary/40">
      <div className="container-prose py-24">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-serif text-3xl md:text-4xl">Investimento estratégico, não custo operacional.</h2>
          <p className="mt-4 text-muted-foreground">
            Cada plano é um seguro contra crise e um acelerador de pauta. Cobramos pelo valor entregue.
          </p>
        </div>
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {PLANS.map((p) => (
            ...
            >
              ...
              <div className="mt-6 font-serif text-4xl">{p.price}<span className="text-base text-muted-foreground font-sans">/mês</span></div>
